...
LDFLAGS=-L/usr/local/python/2.7.18/lib
...
dtc_toric: floquet.o pauli_product.o toric.o stabilizer.o ./test/dtc_toric.cpp
	$(CXX) -o dtc_toric -fopenmp floquet.o pauli_product.o toric.o stabilizer.o ./test/dtc_toric.cpp $(CPPFLAGS)

dtc_toric_mwpm: floquet.o pauli_product.o toric.o stabilizer.o mwpm.o ./test/dtc_toric_mwpm.cpp
	$(CXX) -o dtc_toric_mwpm -fopenmp floquet.o pauli_product.o toric.o stabilizer.o mwpm.o ./test/dtc_toric_mwpm.cpp $(CPPFLAGS) -I/usr/local/python/2.7.18/include/python2.7 $(LDFLAGS) -lpython2.7
...
mwpm.o:./src/mwpm.cpp
	$(CXX) -c $(CPPFLAGS) ./src/mwpm.cpp -I/usr/local/python/2.7.18/include/python2.7 $(LDFLAGS) -lpython2.7
